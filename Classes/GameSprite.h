#ifndef BREAK_OUT_SPRITE
#define BREAK_OUT_SPRITE
...
class GameSprite : public Node, public TextureProtocol
{
public:
...
public:
	...
	* @return  An autoreleased sprite object
	*/
	static GameSprite* create(const std::string& filename, const Rect& rect);
	...
	* @return  An autoreleased sprite object
	*/
	static GameSprite* createWithTexture(Texture2D *texture);
	...
	* @return  An autoreleased sprite object
	*/
	static GameSprite* createWithTexture(Texture2D *texture, const Rect& rect, bool rotated = false);
	...
	* @return  An autoreleased sprite object
	*/
	static GameSprite* createWithSpriteFrame(SpriteFrame *spriteFrame);
...
private:
	CC_DISALLOW_COPY_AND_ASSIGN(GameSprite);
};
