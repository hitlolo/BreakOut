#ifndef BREAK_OUT_POLY_SPRITE
#define BREAK_OUT_POLY_SPRITE
...
class PolySprite : public Node, public TextureProtocol
{
public:
...
public:
	...
	* @return  An autoreleased sprite object.
	*/
	static PolySprite* create(const std::string& filename);
	...
	* @return  An autoreleased sprite object
	*/
	static PolySprite* create(const std::string& filename, const Rect& rect);
	...
	* @return  An autoreleased sprite object
	*/
	static PolySprite* createWithTexture(Texture2D *texture);
	...
	* @return  An autoreleased sprite object
	*/
	static PolySprite* createWithTexture(Texture2D *texture, const Rect& rect, bool rotated = false);
	...
	* @return  An autoreleased sprite object
	*/
	static PolySprite* createWithSpriteFrame(SpriteFrame *spriteFrame);
	...
	* @return  An autoreleased sprite object
	*/
	static PolySprite* createWithSpriteFrameName(const std::string& spriteFrameName);
...
public:
	...
	*/
	...
	///@} start of Sprite properties getter/setters
	/**
...
private:
	CC_DISALLOW_COPY_AND_ASSIGN(PolySprite);
};
